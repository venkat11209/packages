pipeline {
    ...
    stages {
            ...
            steps {
                script {
                    ...
                    emailext (
                        ...
                        to: "$DEFAULT_MAILS,chandrakanth.surikanti@fission.it,likhitha.eluri@fission.it," // Add cloud team and code push to git recipient's email address here
                        )
        ...
        stage('CLONING GIT') {
            steps {
                ...
                checkout(scm: [$class: 'GitSCM', 
                    ...
                    userRemoteConfigs: [[credentialsId: 'Github_sshkey', url: 'git@github.com:fissioninfotech/app.propflip.git']]])
        ...
        stage('DEPLOY') {
            steps {
			    ...
			    sh "rsync --rsh='ssh -p5456' -a ${WORKSPACE}/* root@103.170.86.77:/var/www/html/propflip-project/app.propflip.io"
                sh "rsync --rsh='ssh -p5456' -a ${WORKSPACE}/* root@103.170.86.82:/var/www/html/propflip-project/app.propflip.io"
        ...
        stage('PM2 RESTART') {
            steps {
			    ...
			    sh 'ssh -p22 root@103.170.86.77 "pm2 restart 0"'
                sh 'ssh -p5456 root@103.170.86.82 "pm2 restart 0"'
    ...
    post {
        ...
        failure {
            ...
            attachLog: true,
		to: '$DEFAULT_RECIPIENTS,justin.antony@fission.it,chandrakanth.surikanti@fission.it,likhitha.eluri@fission.it,'
		      }

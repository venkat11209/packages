    ...
    stages {
        ...
        stage('CLONING GIT') {
            steps {
                ...
                checkout(scm: [$class: 'GitSCM', 
                    ...
                    userRemoteConfigs: [[credentialsId: 'Github_sshkey', url: 'git@github.com:fissioninfotech/supportapp.propflip.git']]])
        ...
        stage('DEPLOY') {
            steps {
			    ...
			    sh "rsync --rsh='ssh -p5456' -a ${WORKSPACE}/* root@103.170.86.77:/var/www/html/propflip-project/supportapp.propflip.io"
        ...
        stage('PM2 RESTART') {
            steps {
			    ...
			    sh 'ssh -p5456 root@103.170.86.77 "pm2 restart 6"'

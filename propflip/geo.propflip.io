    ...
    stages {
        ...
        stage('CLONING GIT') {
            steps {
                ...
                checkout(scm: [$class: 'GitSCM', 
                    ...
                    userRemoteConfigs: [[credentialsId: 'Github_sshkey', url: 'git@github.com:fissioninfotech/geo.propflip.git']]])
        ...
        stage('DEPLOY') {
            steps {
			    ...
			    sh "rsync --rsh='ssh -p5456' -a ${WORKSPACE}/* root@103.170.86.77:/var/www/html/propflip-project/geo.propflip.io"
			    sh "rsync --rsh='ssh -p5456' -a ${WORKSPACE}/.env root@103.170.86.77:/var/www/html/propflip-project/geo.propflip.io"
			    sh "rsync --rsh='ssh -p5456' -a ${WORKSPACE}/* root@103.170.86.82:/var/www/html/propflip-project/geo.propflip.io"
			    sh "rsync --rsh='ssh -p5456' -a ${WORKSPACE}/.env root@103.170.86.82:/var/www/html/propflip-project/geo.propflip.io"
        ...
        stage('PM2 RESTART') {
            steps {
			    ...
			    sh 'ssh -p5456 root@103.170.86.77 "pm2 restart 4"'
			    sh 'ssh -p5456 root@103.170.86.82 "pm2 restart 3"'

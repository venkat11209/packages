    ...
    stages {
        ...
        stage('CLONING GIT') {
            steps {
                ...
                git branch: 'shirisha', credentialsId: 'Github_sshkey', url: 'git@github.com:fissioninfotech/leadswatch-api-2023.git'
        ...
        stage('DEPLOY') {
            steps {
        	    ...
        	    sh "rsync --rsh='ssh -p22' -a ${WORKSPACE}/* root@159.223.130.188:/var/www/html/leadswatch-api-2023/"
                sh "rsync --rsh='ssh -p22' -a ${WORKSPACE}/.env root@159.223.130.188:/var/www/html/leadswatch-api-2023/"
                
                sh "rsync --rsh='ssh -p5768' -a ${WORKSPACE}/* root@103.170.86.27:/var/www/html/leadswatch-api-2023/"
                sh "rsync --rsh='ssh -p5768' -a ${WORKSPACE}/.env root@103.170.86.27:/var/www/html/leadswatch-api-2023/"
        ...
        stage('PM2 RESTART') {
            steps {
                ...
                sh 'ssh -p5768 root@103.170.86.27 "pm2 restart 0"'

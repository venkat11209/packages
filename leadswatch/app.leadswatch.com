    ...
    stages {
        ...
        stage('CLONING GIT') {
            steps {
                ...
                git branch: 'gayathri', credentialsId: 'Github_sshkey', url:'git@github.com:fissioninfotech/leadswatch-ui-reactonly-2023.git'
        ...
        stage('DEPLOY') {
            steps {
			    ...
			    sh "rsync --rsh='ssh -p22' -a ${WORKSPACE}/* root@159.223.130.188:/var/www/html/leadswatch-ui-reactonly-2023/"
